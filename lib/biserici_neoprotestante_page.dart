...
class BisericiNeoprotestantePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // ✅ spațiu jos pentru footer (ca să nu acopere conținutul)
    ...
    return Scaffold(
      ...
      // ✅ “buline” sus
      appBar: _floatingPillsHeader(context, "Biserici Neoprotestante"),
          ...
          Positioned.fill(
            child: StreamBuilder<QuerySnapshot>(
              stream: FirebaseFirestore.instance
                  .collection('biserici_neoprotestante')
                  .orderBy('order')
                  .snapshots(),
...
// ---------- CARD (stil 2025 + program full, fără tăiere) ----------
