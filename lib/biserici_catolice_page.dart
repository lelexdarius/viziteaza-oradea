...
class BisericiCatolicePage extends StatelessWidget {
  const BisericiCatolicePage({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      // ✅ “buline” sus
      appBar: _floatingPillsHeader(context, "Biserici Catolice"),
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // ✅ Program FULL (wrap pe mai multe rânduri)
                  Container(
                    width: double.infinity,
                    padding:
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            "Program: $schedule",
                            // fără maxLines / fără overflow -> se vede tot
                            style: TextStyle(
                              fontFamily: 'Poppins',
                              fontSize: 13.2,
                              fontWeight: FontWeight.w800,
